    ...
    <div class="container">
      ...
      <b-form>
        <div class="form">
          ...
          <b-row>
            <b-col>
              <inputComponent type="text" placeholder="Name Of Hotel as per GST" v-model="hotel.hotelName" :required="false"></inputComponent>
            </b-col>
          </b-row>
          <b-row>
            <b-col>
          ...
          <b-row>
            <b-col>
              <inputComponent type="password" placeholder="Password" v-model="hotel.password" :required="false"></inputComponent>
            </b-col>
            <b-col>
              <b-form-group>
          ...
          <b-row>
            <b-col>
              <inputComponent type="text" placeholder="Address" v-model="hotel.hotelAddress" :required="false"></inputComponent>
            </b-col>
          </b-row>
          <b-row>
            <b-col>
          ...
          <b-row class="contact">
            <b-col>
              <inputComponent type="number" placeholder="Landline Number" v-model="hotel.hotelContact.hotelLandline" :required="false"></inputComponent>
            </b-col>
            <b-col>
              <inputComponent type="text" placeholder="Website" v-model="hotel.hotelContact.hotelWebsite" :required="false"></inputComponent>
            </b-col>
          </b-row>
          <b-row class="labels">
            <b-col>
          ...
          <b-row>
            <b-col>
              <inputComponent type="text" placeholder="Name" v-model="hotel.hotelSalesTeam.hotelSalesIncharge.name" :required="false"></inputComponent>
            </b-col>
            <b-col>
              <inputComponent type="number" placeholder="Phone Number" v-model="hotel.hotelSalesTeam.hotelSalesIncharge.number" :required="false"></inputComponent>
            </b-col>
          </b-row>
          <b-row class="labels">
            <b-col>
          ...
          <b-row>
            <b-col>
              <inputComponent type="text" placeholder="Name" v-model="hotel.hotelSalesTeam.hotelCountryHead.name" :required="false"></inputComponent>
            </b-col>
            <b-col>
              <inputComponent type="number" placeholder="Phone Number" v-model="hotel.hotelSalesTeam.hotelCountryHead.number" :required="false"></inputComponent>
            </b-col>
          </b-row>
          <b-row class="labels">
            <b-col>
          ...
          <b-row>
            <b-col>
              <inputComponent type="text" placeholder="Name" v-model="hotel.hotelSalesTeam.hotelRegionHead.name" :required="false"></inputComponent>
            </b-col>
            <b-col>
              <inputComponent type="number" placeholder="Phone Number" v-model="hotel.hotelSalesTeam.hotelRegionHead.number" :required="false"></inputComponent>
            </b-col>
          </b-row>
          <b-row>
            <b-col>
...
<script>
  ...
  export default {
	...
	hotel.hotelSalesTeam.hotelRegionHead.number = hotel.hotelSalesTeam.hotelRegionHead.number === "" ? "0000000000" : hotel.hotelSalesTeam.hotelRegionHead.number
        ...
        if(this.hotel.hotelName && this.hotel.email && this.hotel.password && this.confirmPassword && this.hotel.hotelAddress && this.hotel.hotelCity && this.hotel.hotelState && this.hotel.hotelCountry && this.hotel.hotelContact.hotelLandline 
//&& this.hotel.hotelSalesTeam.hotelSalesIncharge.name && this.hotel.hotelSalesTeam.hotelSalesIncharge.number && this.hotel.hotelSalesTeam.hotelCountryHead.name && this.hotel.hotelSalesTeam.hotelCountryHead.number && this.hotel.hotelSalesTeam.hotelRegionHead.name && this.hotel.hotelSalesTeam.hotelRegionHead.number 
&& !this.emailExists) {
